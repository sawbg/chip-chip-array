...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{ScanQR_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=169pt]{ScanQR_8hpp__dep__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{ScanQR_8hpp_source}{Scan\+Q\+R.\+hpp}.
